...
description: "Analiza automáticamente cada negocio de tu CRM conectado combinando tu registro del CRM con las conversaciones reales que hay detrás, para ver qué negocios avanzan, cuáles están en riesgo y cuáles necesitan atención hoy."
---

El Análisis de Negocios revisa cada negocio (u oportunidad) de tu CRM conectado junto con las conversaciones reales asociadas a él y escribe lo que encuentra en el registro del negocio.
...
<Steps>
  <Step title="Conecta tu CRM con Eazybe">
    El Análisis de Negocios funciona con los negocios de tu CRM conectado. Una vez conectada tu cuenta, los negocios se recogen automáticamente: no hay nada que activar.
  </Step>
  ...
  <Step title="Confirma que el permiso sales-email-read está concedido (solo HubSpot)">
    Si usas HubSpot, la actividad de correo de tus negocios solo puede leerse si tu conexión incluye el permiso **sales-email-read**. La última versión de la integración lo solicita automáticamente.
...
Abre cualquier negocio (u oportunidad) en tu CRM. El análisis aparece junto a tus campos habituales del negocio, en el propio registro: no hay nada aparte que abrir.
...
Para cada negocio u oportunidad de tu pipeline sabrás:
...
<AccordionGroup>
  ...
  <Accordion title="Crea tus propias vistas e informes">
    Todo queda como campos estándar en el registro del negocio, así que puedes filtrar por ello, guardar vistas de lista y crear paneles e informes igual que con cualquier otro campo de tu CRM.
...
<AccordionGroup>
  ...
  <Accordion title="Las ediciones manuales se reemplazan en la siguiente ejecución">
    Puedes escribir encima de un campo de análisis en tu CRM, pero la siguiente ejecución programada lo sobrescribirá. Para registrar tu propio criterio de forma permanente, usa uno de tus campos o añade una nota al negocio.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="¿Puedo filtrar e informar sobre esto como con datos normales del CRM?">
    Sí. Se guarda como campos estándar de negocio, así que los filtros, las vistas de lista guardadas, los paneles y los informes funcionan exactamente igual que con cualquier otro campo de tu CRM.
  </Accordion>
  <Accordion title="¿Tengo que configurar algo en cada negocio?">
    No. Una vez conectado tu CRM, los negocios se analizan automáticamente. No hay nada que activar, configurar ni mantener negocio por negocio.
  </Accordion>
  <Accordion title="¿Por qué no se incluyen los correos de mis negocios de HubSpot?">
    Si usas HubSpot, leer la actividad de correo requiere el permiso **sales-email-read** en tu conexión. Las integraciones creadas antes de que se añadiera este permiso no lo tienen.
