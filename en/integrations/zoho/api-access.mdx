---
title: "Enable Zoho CRM API Access"
description: "Learn how to enable Zoho CRM API access for user profiles to allow Eazybe integration and seamless data communication."
---
...
<Steps>
  ...
  <Step title="Enable API Access">
    ...
    ![Enable API Access](/images/1968892209.png)
  </Step>
