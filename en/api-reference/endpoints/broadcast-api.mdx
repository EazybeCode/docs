...
<Steps>
  <Step>
    <h3>Use Auth Key in Request Headers</h3>
    <p>All broadcast endpoints require the generated Auth key in the <strong>x-api-key</strong> header, and you can find it inside the Workspace → Staff section.</p>
