---
title: "Meta API Wrapper"
description: "Use one authenticated Eazybe REST API to work with WhatsApp Business Cloud API resources."
---

The Meta API Wrapper gives your backend a single REST surface for WhatsApp Business Cloud API operations. Connect a WhatsApp Business Account (WABA) to Eazybe once, then use Eazybe credentials to manage messages, templates, media, analytics, phone numbers, and related Meta resources.
