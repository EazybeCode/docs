...
<CardGroup cols={2}>
  <Card title="Send WhatsApp via Workflows" href="/en/integrations/hubspot/create-workflow" icon="paper-plane">
    Learn more about sending WhatsApp messages through HubSpot workflows
  </Card>
  <Card title="Troubleshoot Workflow Issues" href="/en/integrations/hubspot/workflow-troubleshoot" icon="wrench">
    Common issues and solutions for HubSpot workflow problems
  </Card>
  <Card title="Create Templates with HubSpot Variables" href="/en/waba/templates/how-to-create-template-with-hubspot-variables" icon="file-code">
    Use HubSpot contact properties in your WhatsApp templates
  </Card>
  <Card title="Broadcast Campaigns" href="/en/waba/broadcasting/send-broadcast" icon="bullhorn">
