---
title: "Agente de Base de Conhecimento IA"
...
# Agente de Base de Conhecimento IA
...
<Steps>
  <Step title="Links da Web">
    Insira qualquer URL para extrair conteúdo de sites, artigos do central de ajuda, documentação ou blogs. O agente extrai e indexa automaticamente o conteúdo de texto.
  </Step>
...
- **Papel/Persona**: Defina como a IA deve se comportar (ex. "Você é um representante de suporte ao cliente prestatioso da Acme Corp")
...
- Cole URLs do seu site, central de ajuda ou documentação
