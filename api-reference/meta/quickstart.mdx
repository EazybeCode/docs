...
<Steps>
  <Step title="Set your API host and token">
    Set the Eazybe prod API v2 base URL and your bearer token.
  ...
  <Step title="Subscribe to inbound events">
    ...
    `hub.challenge`, then process standard WhatsApp webhook payloads. The
    [Instant Webhook guide](/en/integrations/webhooks-custom/instant-webhook)
    covers this step by step, with ready-to-use callback code.
  </Step>
</Steps>
